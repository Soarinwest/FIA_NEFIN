...
cat("  ok Phase A: FIA data processed\n")
cat("  ok Phase B: Comparison datasets created\n")
cat("  ok Phase C: Hexagon assignments complete\n")
cat("  ok Phase D: Covariates extracted\n")
cat("  ok Phase E: Analysis complete, figures generated\n\n")
