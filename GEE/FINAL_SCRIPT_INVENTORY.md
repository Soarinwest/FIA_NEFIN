...
## **LAND SURFACE TEMPERATURE (1km) - 3 FILES** (Optional)
...
**Why Critical:**
- Strongest biomass predictor (r^2 ~0.7)
...
**Why Critical:**
- Strong biomass predictor (r^2 ~0.5)
...
Fine scale (10m) - Spectral + Topo:
 NEFIN R^2: 0.55
 FIA R^2: 0.45
 delta: 0.10 Shows fuzzing matters
```

### **With Height (Tier 2 - Recommended):**
```
Fine scale (10m) - All covariates:
 NEFIN R^2: 0.78 (+23% from height!)
 FIA R^2: 0.71
 delta: 0.07 STILL shows fuzzing matters

Better R^2 + Maintains fuzzing effect!
```
...
**Expected Impact:**
- R^2 improvement: +20-30% from height
