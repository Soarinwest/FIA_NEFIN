...
cat("Model formulas:\n")
cat("  Baseline:  biomass ~ ndvi + tmean_250m + ppt_250m\n")
cat("  Enhanced:  biomass ~ ndvi + tmean_250m + ppt_250m + max_dbh_cm\n")
cat("  Full:      biomass ~ ndvi + tmean_250m + ppt_250m + max_dbh_cm + max_ht_m\n\n")
