...
composition_tests <- tibble(
  ...
  ks_statistic = c(
    ks.test(fia_plots$ndvi_s2_10m, nefin_plots$ndvi_s2_10m)$statistic,
    ks.test(fia_plots$tmean_250m, nefin_plots$tmean_250m)$statistic,
    ks.test(fia_plots$ppt_250m, nefin_plots$ppt_250m)$statistic,
    ks.test(fia_plots$biomass, nefin_plots$biomass)$statistic
  ),
  p_value = c(
    ks.test(fia_plots$ndvi_s2_10m, nefin_plots$ndvi_s2_10m)$p.value,
    ks.test(fia_plots$tmean_250m, nefin_plots$tmean_250m)$p.value,
    ks.test(fia_plots$ppt_250m, nefin_plots$ppt_250m)$p.value,
