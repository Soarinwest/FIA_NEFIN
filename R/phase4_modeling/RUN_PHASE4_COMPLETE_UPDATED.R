...
cat("ok Step 1 complete in", round(step1_time, 1), "minutes\n\n")
...
cat("ok Step 2 complete in", round(step2_time, 1), "minutes\n\n")
...
cat("  Running 6 models (2 scales x 3 scenarios)\n")
cat("-------------------------------------------------------------------\n")
...
cat("ok Step 3 complete in", round(step3_time, 1), "minutes\n\n")
...
cat("ok Step 4 complete in", round(step4_time, 1), "minutes\n\n")
...
cat("  - Total: 6 models x 10 folds = 60 model fits\n\n")
...
cat("  ok Quantified fuzzing effects at two scales\n")
cat("  ok AUC/ROC curves for classification\n")
cat("  ok Spatial validation with proper CV\n")
cat("  ok Publication-quality figures\n")
cat("  ok Statistical summaries with uncertainty\n\n")
